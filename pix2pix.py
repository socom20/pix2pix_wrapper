...
def create_model(a, inputs, targets):
...
##        print(k, "=", v)
    ...
    if a.mode == "export":
        ...
        with tf.variable_scope("generator"):
            batch_output = deprocess(create_generator(a, preprocess(batch_input), 3))
...
if __name__ == '__main__':
    ...
    a = parser.parse_args()
##    a = parser.parse_args(['--input_dir', './A', '--output_dir', './B', '--mode', 'test', '--checkpoint', './sketchtophoto_train'])
